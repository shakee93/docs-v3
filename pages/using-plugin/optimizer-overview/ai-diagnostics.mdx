...
RapidLoad's **AI Diagnostics** is a powerful feature that allows you to run a 
comprehensive diagnostic report for your website. It provides detailed insights 
into audits and metrics that require optimization or resolution, along with 
actionable guidance to address them effectively.

## How to Use AI Diagnostics

**Navigate to AI Diagnostics**

Log into RapidLoad and go to the **Optimize** section within the plugin (located next to
the **Page Speed Insights** section).
