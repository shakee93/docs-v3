...
with minified css files renamed with the `Href` and version(`?ver=xxx`) details.
    *   Original file: `https://demo.rapidload.ai/wp-includes/blocks/navigation/style.css?ver=6.3.2`
    *   Minified file: `https://demo.rapidload.ai/wp-content/cache/rapidload/min-css/style-9a7d09a200c6.min.css`
