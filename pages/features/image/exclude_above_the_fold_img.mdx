...
src="/images/rl-docs-images/features/exclude-above-the-fold-images.png" alt="Exclude Above the Fold Images" />

Lazy loading is a great way to make your website faster by loading images only when they’re needed. 
But for **above-the-fold images** the ones your visitors see right away it’s better to load them instantly.
