...
Navigate to your WordPress plugins dashboard, locate RapidLoad, and click the update button. [*_Learn more_*](/getting-started/installation#updates--rollback)
...
You will find the Titan Optimizer on the optimize page, integrated into the main 
optimization workflow in the Optimize section. [*_Learn more_*](/using-plugin/optimizer-overview)
...
You will find Test Mode in the header area, unified for both Dashboard and Optimize sections. [*_Learn more_*](/using-plugin/test-mode)
...
The Dashboard now includes usage summaries for Cache, CDN, and Image optimizations, Before/After RapidLoad performance scores, current gear mode display, AI chat integration, and reorganized license details. [*_Learn more_*](/using-plugin/dashboard-overview)
...
RapidLoad 3.0 provides AI Diagnostics for performance analysis, AI Chat for assistance, and AI Prediction for optimization recommendations. [*_Learn more_*](/using-plugin/optimizer-overview/ai-diagnostics)
...
All optimization configurations are centralized in the Optimize section. [*_Learn more_*](/using-plugin/optimizer-overview)
